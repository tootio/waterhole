...
# The release tag, set by the release workflow; error reports carry it as their
# release. Empty for local builds.
ARG WATERHOLE_VERSION=""
ENV WATERHOLE_VERSION="${WATERHOLE_VERSION}"
