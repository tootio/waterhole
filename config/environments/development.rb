...
Rails.application.configure do
  ...
  # Waterhole's core loop is a recurring job, so development runs Solid Queue for
  # real (see config/database.yml and Procfile.dev) rather than the :async adapter,
