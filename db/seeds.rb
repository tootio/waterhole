...
avery = alpha.moderators.create!(mastodon_account_id: "1", username: "avery",
  display_name: "Avery", access_token: "seed-token-avery", last_authenticated_at: Time.current)
blake = alpha.moderators.create!(mastodon_account_id: "2", username: "blake",
  display_name: "Blake", access_token: "seed-token-blake", last_authenticated_at: 1.day.ago)
beta.moderators.create!(mastodon_account_id: "3", username: "casey",
  display_name: "Casey", access_token: "seed-token-casey", last_authenticated_at: Time.current)
...
puts "  IP databases:    #{Ip::Databases.ready? ? "installed" : "not installed - run waterhole:mmdb:refresh"}"
