...
class Flags::IpActiveElsewhereTest < ActiveSupport::TestCase
  ...
  test "the purge clears the generated match key along with the address" do
    ...
    assert_nil a.reload.ip_group,
      "a derived key surviving the purge would keep matching people after their record was erased"
  end
end
